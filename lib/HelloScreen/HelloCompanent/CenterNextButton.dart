                    ...
                    child: _signUpMoveAnimation.value > 0.7
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              AppLocalizations.of(context).translate("HelloScren.Sing_Up"),
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 18,
          ...
          Padding(
            ...
            child: SlideTransition(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    AppLocalizations.of(context).translate("HelloScren.Dont_have_an_account"),
                    style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      AppLocalizations.of(context).translate("HelloScren.Sing_in"),
                      style: TextStyle(
                        color: Color(0xff132137),
                        fontSize: 16,
