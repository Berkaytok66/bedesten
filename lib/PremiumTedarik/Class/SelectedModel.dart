...
class SelectedModel extends StatefulWidget {
  final String Marka;

  SelectedModel({required this.Marka});

  @override
  State<SelectedModel> createState() => _SelectedModelState();
}

class _SelectedModelState extends State<SelectedModel> {
  ...
  void someFunction() async {
    ...
    List<String> allBrands = brandModels.getModelsByBrand(widget.Marka);
  ...
  Widget build(BuildContext context) {
    String getMarka = widget.Marka;
    return Scaffold(
      appBar: AppBar(
        title: Text("Cihaz Modelini Seçin"),
      ),
