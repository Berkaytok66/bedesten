...
class FavoriteMarketWidget extends StatelessWidget {
  const FavoriteMarketWidget({super.key});
  ...
  Widget build(BuildContext context) {
    final List<Product> products = [
      ...
      Product(name: 'Steelseries Rival 3 RGB Kablolu Oyun Mouse',photo: "https://resim.epey.com/716042/m_xiaomi-11t-1.png",locasyon: "Manisa/Alaşehir"),
      Product(name: 'Steelseries Rival 3 RGB Kablolu Oyun Mouse',photo: "https://resim.epey.com/1/m_samsung-galaxy-s4-5.jpg",locasyon: "Manisa/Alaşehir"),
      Product(name: 'Steelseries Rival 3 RGB Kablolu Oyun Mouse',photo: "https://resim.epey.com/716503/m_apple-iphone-13-23.jpg",locasyon: "Manisa/Alaşehir"),
...
class Product {
  ...
  Product({required this.name, required this.photo,required this.locasyon});
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: IconButton(
                icon: Icon(Icons.favorite,color: Colors.red,size: MediaQuery.of(context).size.height /30,),
                onPressed: () {
